...
func (d *Context) CheckTypeMask(index int, mask uint) bool { log.DebugLog()
...
func (d *Context) CompileLstring(flags uint, src string, len int) { log.DebugLog()
...
func (d *Context) CompileLstringFilename(flags uint, src string, len int) { log.DebugLog()
	__src__ := C.CString(src)
...
func (d *Context) CompileString(flags uint, src string) { log.DebugLog()
	__src__ := C.CString(src)
...
func (d *Context) CompileStringFilename(flags uint, src string) { log.DebugLog()
	__src__ := C.CString(src)
...
func (d *Context) DelPropString(objIndex int, key string) bool { log.DebugLog()
...
func (d *Context) Error(errCode int, str string) { log.DebugLog()
	__str__ := C.CString(str)
	C._duk_error(d.duk_context, C.duk_errcode_t(errCode), __str__)
	C.free(unsafe.Pointer(__str__))
}

func (d *Context) ErrorRaw(errCode int, filename string, line int, errMsg string) { log.DebugLog()
...
//
// See: http://duktape.org/api.html#duk_error
func (d *Context) Errorf(errCode int, format string, a ...interface{}) { log.DebugLog()
...
func (d *Context) Eval() { log.DebugLog()
	C._duk_eval(d.duk_context)
}

// See: http://duktape.org/api.html#duk_eval_file
func (d *Context) EvalFile(path string) { log.DebugLog()
	__path__ := C.CString(path)
...
func (d *Context) EvalFileNoresult(path string) { log.DebugLog()
	__path__ := C.CString(path)
...
func (d *Context) EvalLstring(src string, len int) { log.DebugLog()
	__src__ := C.CString(src)
...
func (d *Context) EvalLstringNoresult(src string, len int) { log.DebugLog()
	__src__ := C.CString(src)
...
func (d *Context) EvalNoresult() { log.DebugLog()
	C._duk_eval_noresult(d.duk_context)
}

// See: http://duktape.org/api.html#duk_eval_string
func (d *Context) EvalString(src string) { log.DebugLog()
	__src__ := C.CString(src)
...
func (d *Context) EvalStringNoresult(src string) { log.DebugLog()
	__src__ := C.CString(src)
...
func (d *Context) Fatal(errCode int, errMsg string) { log.DebugLog()
	__errMsg__ := C.CString(errMsg)
...
func (d *Context) GetContext(index int) *Context { log.DebugLog()
...
func (d *Context) GetPropString(objIndex int, key string) bool { log.DebugLog()
	__key__ := C.CString(key)
...
func (d *Context) GetPrototype(index int) { log.DebugLog()
	C.duk_get_prototype(d.duk_context, C.duk_idx_t(index))
}

// See: http://duktape.org/api.html#duk_get_string
func (d *Context) GetString(i int) string { log.DebugLog()
...
func (d *Context) HasPropString(objIndex int, key string) bool { log.DebugLog()
	__key__ := C.CString(key)
...
func (d *Context) HexDecode(index int) { log.DebugLog()
	C.duk_hex_decode(d.duk_context, C.duk_idx_t(index))
}

// See: http://duktape.org/api.html#duk_hex_encode
func (d *Context) HexEncode(index int) string { log.DebugLog()
...
func (d *Context) IsEcmascriptFunction(index int) bool { log.DebugLog()
...
func (d *Context) New(nargs int) { log.DebugLog()
	C.duk_new(d.duk_context, C.duk_idx_t(nargs))
}

// See: http://duktape.org/api.html#duk_next
func (d *Context) Next(enumIndex int, getValue bool) bool { log.DebugLog()
...
func (d *Context) Pcompile(flags uint) error { log.DebugLog()
...
func (d *Context) PcompileFile(flags uint, path string) error { log.DebugLog()
	__path__ := C.CString(path)
...
func (d *Context) PcompileLstring(flags uint, src string, len int) error { log.DebugLog()
	__src__ := C.CString(src)
...
func (d *Context) PcompileLstringFilename(flags uint, src string, len int) error { log.DebugLog()
	__src__ := C.CString(src)
...
func (d *Context) PcompileString(flags uint, src string) error { log.DebugLog()
	__src__ := C.CString(src)
...
func (d *Context) PcompileStringFilename(flags uint, src string) error { log.DebugLog()
	__src__ := C.CString(src)
...
func (d *Context) Peval() error { log.DebugLog()
	result := int(C._duk_peval(d.duk_context))
	return d.castStringToError(result)
}

// See: http://duktape.org/api.html#duk_peval_file
func (d *Context) PevalFile(path string) error { log.DebugLog()
	__path__ := C.CString(path)
...
func (d *Context) PevalFileNoresult(path string) int { log.DebugLog()
	__path__ := C.CString(path)
...
func (d *Context) PevalLstring(src string, len int) error { log.DebugLog()
	__src__ := C.CString(src)
...
func (d *Context) PevalLstringNoresult(src string, len int) int { log.DebugLog()
	__src__ := C.CString(src)
...
func (d *Context) PevalNoresult() int { log.DebugLog()
	return int(C._duk_peval_noresult(d.duk_context))
}

// See: http://duktape.org/api.html#duk_peval_string
func (d *Context) PevalString(src string) error { log.DebugLog()
	__src__ := C.CString(src)
...
func (d *Context) PevalStringNoresult(src string) int { log.DebugLog()
	__src__ := C.CString(src)
...
func (d *Context) castStringToError(result int) error { log.DebugLog()
	if result == 0 {
		return nil
	}
...
func (d *Context) Pop() { log.DebugLog()
	if d.GetTop() == 0 {
		return
	}
...
func (d *Context) Pop2() { log.DebugLog()
	d.PopN(2)
}

// See: http://duktape.org/api.html#duk_pop_3
func (d *Context) Pop3() { log.DebugLog()
	d.PopN(3)
}

// See: http://duktape.org/api.html#duk_pop_n
func (d *Context) PopN(count int) { log.DebugLog()
...
func (d *Context) PushArray() int { log.DebugLog()
	return int(C.duk_push_array(d.duk_context))
}

// See: http://duktape.org/api.html#duk_push_boolean
func (d *Context) PushBoolean(val bool) { log.DebugLog()
	var __val__ int
	if val {
		__val__ = 1
	}
...
func (d *Context) PushBuffer(size int, dynamic bool) unsafe.Pointer { log.DebugLog()
	var __dynamic__ int
	if dynamic {
		__dynamic__ = 1
	}
...
func (d *Context) PushStringFile(path string) string { log.DebugLog()
	__path__ := C.CString(path)
	var result string
...
func (d *Context) PutProp(objIndex int) bool { log.DebugLog()
	return int(C.duk_put_prop(d.duk_context, C.duk_idx_t(objIndex))) == 1
}

// See: http://duktape.org/api.html#duk_put_prop_index
func (d *Context) PutPropIndex(objIndex int, arrIndex uint) bool { log.DebugLog()
...
func (d *Context) PutPropString(objIndex int, key string) bool { log.DebugLog()
	__key__ := C.CString(key)
...
func (d *Context) RequireCallable(index int) { log.DebugLog()
...
func (d *Context) RequireContext(index int) *Context { log.DebugLog()
...
func (d *Context) SafeCall(fn, args *[0]byte, nargs, nrets int) int { log.DebugLog()
...
func (d *Context) SafeToLstring(index int) string { log.DebugLog()
...
func (d *Context) SafeToString(index int) string { log.DebugLog()
...
func (d *Context) Substring(index int, startCharOffset int, endCharOffset int) { log.DebugLog()
...
func (d *Context) ToDefaultvalue(index int, hint int) { log.DebugLog()
...
func (d *Context) ToDynamicBuffer(index int) (rawPtr unsafe.Pointer, outSize uint) { log.DebugLog()
...
func (d *Context) ToFixedBuffer(index int) (rawPtr unsafe.Pointer, outSize uint) { log.DebugLog()
...
func (d *Context) LogVa(logLevel int, format string, values ...interface{}) { log.DebugLog()
...
func (d *Context) Pnew(nargs int) error { log.DebugLog()
	result := int(C.duk_pnew(d.duk_context, C.duk_idx_t(nargs)))
	return d.castStringToError(result)
}

// See: http://duktape.org/api.html#duk_push_buffer_object
func (d *Context) PushBufferObject(bufferIdx, size, length int, flags uint) { log.DebugLog()
...
func (d *Context) PushCLightfunc(fn *[0]byte, nargs, length, magic int) int { log.DebugLog()
...
func (d *Context) PushErrorObjectVa(errCode int, format string, values ...interface{}) { log.DebugLog()
	__str__ := C.CString(fmt.Sprintf(format, values...))
	C._duk_push_error_object(d.duk_context, C.duk_errcode_t(errCode), __str__)
	C.free(unsafe.Pointer(__str__))
}
...
func (d *Context) PushExternalBuffer() { log.DebugLog()
