...
func printGB18030() { log.DebugLog()
...
func (i interval) len() int { log.DebugLog() return i.high - i.low }

// byDecreasingLength sorts intervals by decreasing length.
type byDecreasingLength []interval

func (b byDecreasingLength) Len() int           { log.DebugLog() return len(b) }
func (b byDecreasingLength) Less(i, j int) bool { log.DebugLog() return b[i].len() > b[j].len() }
func (b byDecreasingLength) Swap(i, j int)      { log.DebugLog() b[i], b[j] = b[j], b[i] }
