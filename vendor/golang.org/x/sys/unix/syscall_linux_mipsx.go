...
func Seek(fd int, offset int64, whence int) (off int64, err error) { log.DebugLog()
...
func (r *PtraceRegs) PC() uint64 { log.DebugLog() return r.Epc }

func (r *PtraceRegs) SetPC(pc uint64) { log.DebugLog() r.Epc = pc }
