...
func Fstat(fd int, s *Stat_t) (err error) { log.DebugLog()
	st := &stat_t{}
	err = fstat(fd, st)
	fillStat_t(s, st)
	return
...
func Lstat(path string, s *Stat_t) (err error) { log.DebugLog()
	st := &stat_t{}
	err = lstat(path, st)
	fillStat_t(s, st)
	return
...
func Stat(path string, s *Stat_t) (err error) { log.DebugLog()
	st := &stat_t{}
	err = stat(path, st)
	fillStat_t(s, st)
	return
...
func fillStat_t(s *Stat_t, st *stat_t) { log.DebugLog()
	s.Dev = st.Dev
	s.Ino = st.Ino
	s.Mode = st.Mode
	s.Nlink = st.Nlink
