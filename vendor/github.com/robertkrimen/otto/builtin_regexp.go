...
func builtinRegExp(call FunctionCall) Value { log.DebugLog()
...
func builtinNewRegExp(self *_object, argumentList []Value) Value { log.DebugLog()
...
func builtinRegExp_toString(call FunctionCall) Value { log.DebugLog()
...
func builtinRegExp_exec(call FunctionCall) Value { log.DebugLog()
	thisObject := call.thisObject()
...
func builtinRegExp_test(call FunctionCall) Value { log.DebugLog()
	thisObject := call.thisObject()
	target := call.Argument(0).string()
...
func builtinRegExp_compile(call FunctionCall) Value { log.DebugLog()
