...
func (runtime *_runtime) newGoMapObject(value reflect.Value) *_object { log.DebugLog()
...
func _newGoMapObject(value reflect.Value) *_goMapObject { log.DebugLog()
...
func (self _goMapObject) toKey(name string) reflect.Value { log.DebugLog()
...
func (self _goMapObject) toValue(value Value) reflect.Value { log.DebugLog()
...
func goMapGetOwnProperty(self *_object, name string) *_property { log.DebugLog()
...
func goMapEnumerate(self *_object, all bool, each func(string) bool) { log.DebugLog()
	object := self.value.(*_goMapObject)
...
func goMapDefineOwnProperty(self *_object, name string, descriptor _property, throw bool) bool { log.DebugLog()
	object := self.value.(*_goMapObject)
	// TODO ...or 0222
...
func goMapDelete(self *_object, name string, throw bool) bool { log.DebugLog()
	object := self.value.(*_goMapObject)
