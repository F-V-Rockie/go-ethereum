...
func builtinArray(call FunctionCall) Value { log.DebugLog()
	return toValue_object(builtinNewArrayNative(call.runtime, call.ArgumentList))
}

func builtinNewArray(self *_object, argumentList []Value) Value { log.DebugLog()
	return toValue_object(builtinNewArrayNative(self.runtime, argumentList))
}

func builtinNewArrayNative(runtime *_runtime, argumentList []Value) *_object { log.DebugLog()
...
func builtinArray_toString(call FunctionCall) Value { log.DebugLog()
...
func builtinArray_toLocaleString(call FunctionCall) Value { log.DebugLog()
	separator := ","
	thisObject := call.thisObject()
...
func builtinArray_concat(call FunctionCall) Value { log.DebugLog()
	thisObject := call.thisObject()
	valueArray := []Value{}
...
func builtinArray_shift(call FunctionCall) Value { log.DebugLog()
	thisObject := call.thisObject()
	length := int64(toUint32(thisObject.get("length")))
	if 0 == length {
...
func builtinArray_push(call FunctionCall) Value { log.DebugLog()
	thisObject := call.thisObject()
...
func builtinArray_pop(call FunctionCall) Value { log.DebugLog()
	thisObject := call.thisObject()
	length := int64(toUint32(thisObject.get("length")))
	if 0 == length {
...
func builtinArray_join(call FunctionCall) Value { log.DebugLog()
	separator := ","
	{
...
func builtinArray_splice(call FunctionCall) Value { log.DebugLog()
	thisObject := call.thisObject()
	length := int64(toUint32(thisObject.get("length")))
...
func builtinArray_slice(call FunctionCall) Value { log.DebugLog()
	thisObject := call.thisObject()
...
func builtinArray_unshift(call FunctionCall) Value { log.DebugLog()
	thisObject := call.thisObject()
	length := int64(toUint32(thisObject.get("length")))
	itemList := call.ArgumentList
...
func builtinArray_reverse(call FunctionCall) Value { log.DebugLog()
	thisObject := call.thisObject()
	length := int64(toUint32(thisObject.get("length")))
...
func sortCompare(thisObject *_object, index0, index1 uint, compare *_object) int { log.DebugLog()
	j := struct {
		name    string
		exists  bool
		defined bool
...
func arraySortSwap(thisObject *_object, index0, index1 uint) { log.DebugLog()
...
func arraySortQuickPartition(thisObject *_object, left, right, pivot uint, compare *_object) (uint, uint) { log.DebugLog()
...
func arraySortQuickSort(thisObject *_object, left, right uint, compare *_object) { log.DebugLog()
	if left < right {
...
func builtinArray_sort(call FunctionCall) Value { log.DebugLog()
	thisObject := call.thisObject()
...
func builtinArray_isArray(call FunctionCall) Value { log.DebugLog()
	return toValue_bool(isArray(call.Argument(0)._object()))
}

func builtinArray_indexOf(call FunctionCall) Value { log.DebugLog()
...
func builtinArray_lastIndexOf(call FunctionCall) Value { log.DebugLog()
	thisObject, matchValue := call.thisObject(), call.Argument(0)
	length := int64(toUint32(thisObject.get("length")))
	index := length - 1
	if len(call.ArgumentList) > 1 {
...
func builtinArray_every(call FunctionCall) Value { log.DebugLog()
	thisObject := call.thisObject()
...
func builtinArray_some(call FunctionCall) Value { log.DebugLog()
	thisObject := call.thisObject()
	this := toValue_object(thisObject)
	if iterator := call.Argument(0); iterator.isCallable() {
		length := int64(toUint32(thisObject.get("length")))
...
func builtinArray_forEach(call FunctionCall) Value { log.DebugLog()
	thisObject := call.thisObject()
	this := toValue_object(thisObject)
	if iterator := call.Argument(0); iterator.isCallable() {
		length := int64(toUint32(thisObject.get("length")))
...
func builtinArray_map(call FunctionCall) Value { log.DebugLog()
	thisObject := call.thisObject()
	this := toValue_object(thisObject)
	if iterator := call.Argument(0); iterator.isCallable() {
		length := int64(toUint32(thisObject.get("length")))
...
func builtinArray_filter(call FunctionCall) Value { log.DebugLog()
	thisObject := call.thisObject()
	this := toValue_object(thisObject)
	if iterator := call.Argument(0); iterator.isCallable() {
		length := int64(toUint32(thisObject.get("length")))
...
func builtinArray_reduce(call FunctionCall) Value { log.DebugLog()
	thisObject := call.thisObject()
	this := toValue_object(thisObject)
	if iterator := call.Argument(0); iterator.isCallable() {
...
func builtinArray_reduceRight(call FunctionCall) Value { log.DebugLog()
	thisObject := call.thisObject()
	this := toValue_object(thisObject)
	if iterator := call.Argument(0); iterator.isCallable() {
		initial := len(call.ArgumentList) > 1
