...
func builtinDate(call FunctionCall) Value { log.DebugLog()
	date := &_dateObject{}
	date.Set(newDateTime([]Value{}, Time.Local))
	return toValue_string(date.Time().Format(builtinDate_goDateTimeLayout))
}

func builtinNewDate(self *_object, argumentList []Value) Value { log.DebugLog()
	return toValue_object(self.runtime.newDate(newDateTime(argumentList, Time.Local)))
}

func builtinDate_toString(call FunctionCall) Value { log.DebugLog()
...
func builtinDate_toDateString(call FunctionCall) Value { log.DebugLog()
	date := dateObjectOf(call.runtime, call.thisObject())
	if date.isNaN {
		return toValue_string("Invalid Date")
	}
...
func builtinDate_toTimeString(call FunctionCall) Value { log.DebugLog()
	date := dateObjectOf(call.runtime, call.thisObject())
	if date.isNaN {
		return toValue_string("Invalid Date")
	}
...
func builtinDate_toUTCString(call FunctionCall) Value { log.DebugLog()
	date := dateObjectOf(call.runtime, call.thisObject())
	if date.isNaN {
		return toValue_string("Invalid Date")
	}
...
func builtinDate_toISOString(call FunctionCall) Value { log.DebugLog()
	date := dateObjectOf(call.runtime, call.thisObject())
	if date.isNaN {
		return toValue_string("Invalid Date")
	}
...
func builtinDate_toJSON(call FunctionCall) Value { log.DebugLog()
...
func builtinDate_toGMTString(call FunctionCall) Value { log.DebugLog()
	date := dateObjectOf(call.runtime, call.thisObject())
	if date.isNaN {
		return toValue_string("Invalid Date")
	}
...
func builtinDate_getTime(call FunctionCall) Value { log.DebugLog()
	date := dateObjectOf(call.runtime, call.thisObject())
	if date.isNaN {
		return NaNValue()
	}
...
func builtinDate_setTime(call FunctionCall) Value { log.DebugLog()
	object := call.thisObject()
	date := dateObjectOf(call.runtime, call.thisObject())
...
func _builtinDate_beforeSet(call FunctionCall, argumentLimit int, timeLocal bool) (*_object, *_dateObject, *_ecmaTime, []int) { log.DebugLog()
	object := call.thisObject()
	date := dateObjectOf(call.runtime, call.thisObject())
	if date.isNaN {
...
func builtinDate_parse(call FunctionCall) Value { log.DebugLog()
	date := call.Argument(0).string()
	return toValue_float64(dateParse(date))
}

func builtinDate_UTC(call FunctionCall) Value { log.DebugLog()
	return toValue_float64(newDateTime(call.ArgumentList, Time.UTC))
}

func builtinDate_now(call FunctionCall) Value { log.DebugLog()
	call.ArgumentList = []Value(nil)
	return builtinDate_UTC(call)
}

// This is a placeholder
func builtinDate_toLocaleString(call FunctionCall) Value { log.DebugLog()
	date := dateObjectOf(call.runtime, call.thisObject())
	if date.isNaN {
		return toValue_string("Invalid Date")
	}
...
// This is a placeholder
func builtinDate_toLocaleDateString(call FunctionCall) Value { log.DebugLog()
	date := dateObjectOf(call.runtime, call.thisObject())
	if date.isNaN {
		return toValue_string("Invalid Date")
	}
...
// This is a placeholder
func builtinDate_toLocaleTimeString(call FunctionCall) Value { log.DebugLog()
	date := dateObjectOf(call.runtime, call.thisObject())
	if date.isNaN {
		return toValue_string("Invalid Date")
	}
...
func builtinDate_valueOf(call FunctionCall) Value { log.DebugLog()
	date := dateObjectOf(call.runtime, call.thisObject())
	if date.isNaN {
		return NaNValue()
	}
...
func builtinDate_getYear(call FunctionCall) Value { log.DebugLog()
...
func builtinDate_getFullYear(call FunctionCall) Value { log.DebugLog()
	// Will throw a TypeError is ThisObject is nil or
	// does not have Class of "Date"
	date := dateObjectOf(call.runtime, call.thisObject())
	if date.isNaN {
...
func builtinDate_getUTCFullYear(call FunctionCall) Value { log.DebugLog()
	date := dateObjectOf(call.runtime, call.thisObject())
	if date.isNaN {
		return NaNValue()
	}
...
func builtinDate_getMonth(call FunctionCall) Value { log.DebugLog()
	date := dateObjectOf(call.runtime, call.thisObject())
	if date.isNaN {
		return NaNValue()
	}
...
func builtinDate_getUTCMonth(call FunctionCall) Value { log.DebugLog()
	date := dateObjectOf(call.runtime, call.thisObject())
	if date.isNaN {
		return NaNValue()
	}
...
func builtinDate_getDate(call FunctionCall) Value { log.DebugLog()
	date := dateObjectOf(call.runtime, call.thisObject())
	if date.isNaN {
		return NaNValue()
	}
...
func builtinDate_getUTCDate(call FunctionCall) Value { log.DebugLog()
	date := dateObjectOf(call.runtime, call.thisObject())
	if date.isNaN {
		return NaNValue()
	}
...
func builtinDate_getDay(call FunctionCall) Value { log.DebugLog()
...
func builtinDate_getUTCDay(call FunctionCall) Value { log.DebugLog()
	date := dateObjectOf(call.runtime, call.thisObject())
	if date.isNaN {
		return NaNValue()
	}
...
func builtinDate_getHours(call FunctionCall) Value { log.DebugLog()
	date := dateObjectOf(call.runtime, call.thisObject())
	if date.isNaN {
		return NaNValue()
	}
...
func builtinDate_getUTCHours(call FunctionCall) Value { log.DebugLog()
	date := dateObjectOf(call.runtime, call.thisObject())
	if date.isNaN {
		return NaNValue()
	}
...
func builtinDate_getMinutes(call FunctionCall) Value { log.DebugLog()
	date := dateObjectOf(call.runtime, call.thisObject())
	if date.isNaN {
		return NaNValue()
	}
...
func builtinDate_getUTCMinutes(call FunctionCall) Value { log.DebugLog()
	date := dateObjectOf(call.runtime, call.thisObject())
	if date.isNaN {
		return NaNValue()
	}
...
func builtinDate_getSeconds(call FunctionCall) Value { log.DebugLog()
	date := dateObjectOf(call.runtime, call.thisObject())
	if date.isNaN {
		return NaNValue()
	}
...
func builtinDate_getUTCSeconds(call FunctionCall) Value { log.DebugLog()
	date := dateObjectOf(call.runtime, call.thisObject())
	if date.isNaN {
		return NaNValue()
	}
...
func builtinDate_getMilliseconds(call FunctionCall) Value { log.DebugLog()
	date := dateObjectOf(call.runtime, call.thisObject())
	if date.isNaN {
		return NaNValue()
	}
...
func builtinDate_getUTCMilliseconds(call FunctionCall) Value { log.DebugLog()
	date := dateObjectOf(call.runtime, call.thisObject())
	if date.isNaN {
		return NaNValue()
	}
...
func builtinDate_getTimezoneOffset(call FunctionCall) Value { log.DebugLog()
	date := dateObjectOf(call.runtime, call.thisObject())
	if date.isNaN {
		return NaNValue()
	}
...
func builtinDate_setMilliseconds(call FunctionCall) Value { log.DebugLog()
...
func builtinDate_setUTCMilliseconds(call FunctionCall) Value { log.DebugLog()
...
func builtinDate_setSeconds(call FunctionCall) Value { log.DebugLog()
...
func builtinDate_setUTCSeconds(call FunctionCall) Value { log.DebugLog()
...
func builtinDate_setMinutes(call FunctionCall) Value { log.DebugLog()
...
func builtinDate_setUTCMinutes(call FunctionCall) Value { log.DebugLog()
...
func builtinDate_setHours(call FunctionCall) Value { log.DebugLog()
...
func builtinDate_setUTCHours(call FunctionCall) Value { log.DebugLog()
...
func builtinDate_setDate(call FunctionCall) Value { log.DebugLog()
	object, date, ecmaTime, value := _builtinDate_beforeSet(call, 1, true)
	if ecmaTime == nil {
		return NaNValue()
	}
...
func builtinDate_setUTCDate(call FunctionCall) Value { log.DebugLog()
	object, date, ecmaTime, value := _builtinDate_beforeSet(call, 1, false)
	if ecmaTime == nil {
		return NaNValue()
	}
...
func builtinDate_setMonth(call FunctionCall) Value { log.DebugLog()
	object, date, ecmaTime, value := _builtinDate_beforeSet(call, 2, true)
	if ecmaTime == nil {
		return NaNValue()
	}
...
func builtinDate_setUTCMonth(call FunctionCall) Value { log.DebugLog()
	object, date, ecmaTime, value := _builtinDate_beforeSet(call, 2, false)
	if ecmaTime == nil {
		return NaNValue()
	}
...
func builtinDate_setYear(call FunctionCall) Value { log.DebugLog()
	object, date, ecmaTime, value := _builtinDate_beforeSet(call, 1, true)
	if ecmaTime == nil {
		return NaNValue()
	}
...
func builtinDate_setFullYear(call FunctionCall) Value { log.DebugLog()
	object, date, ecmaTime, value := _builtinDate_beforeSet(call, 3, true)
	if ecmaTime == nil {
		return NaNValue()
	}
...
func builtinDate_setUTCFullYear(call FunctionCall) Value { log.DebugLog()
	object, date, ecmaTime, value := _builtinDate_beforeSet(call, 3, false)
	if ecmaTime == nil {
		return NaNValue()
	}
