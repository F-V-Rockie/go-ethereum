...
func builtinError(call FunctionCall) Value { log.DebugLog()
	return toValue_object(call.runtime.newError("Error", call.Argument(0), 1))
}

func builtinNewError(self *_object, argumentList []Value) Value { log.DebugLog()
	return toValue_object(self.runtime.newError("Error", valueOfArrayIndex(argumentList, 0), 0))
}

func builtinError_toString(call FunctionCall) Value { log.DebugLog()
