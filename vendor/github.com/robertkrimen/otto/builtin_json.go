...
func builtinJSON_parse(call FunctionCall) Value { log.DebugLog()
...
func builtinJSON_reviveWalk(ctx _builtinJSON_parseContext, holder *_object, name string) Value { log.DebugLog()
...
func builtinJSON_parseWalk(ctx _builtinJSON_parseContext, rawValue interface{}) (Value, bool) { log.DebugLog()
...
func builtinJSON_stringify(call FunctionCall) Value { log.DebugLog()
...
func builtinJSON_stringifyWalk(ctx _builtinJSON_stringifyContext, key string, holder *_object) (interface{}, bool) { log.DebugLog()
