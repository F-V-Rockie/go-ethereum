...
func isIdentifier(string_ string) bool { log.DebugLog()
	return isIdentifier_Regexp.MatchString(string_)
}

func (self *_runtime) toValueArray(arguments ...interface{}) []Value { log.DebugLog()
...
func stringToArrayIndex(name string) int64 { log.DebugLog()
...
func isUint32(value int64) bool { log.DebugLog()
	return value >= 0 && value <= maxUint32
}

func arrayIndexToString(index int64) string { log.DebugLog()
	return strconv.FormatInt(index, 10)
}

func valueOfArrayIndex(array []Value, index int) Value { log.DebugLog()
	value, _ := getValueOfArrayIndex(array, index)
	return value
}

func getValueOfArrayIndex(array []Value, index int) (Value, bool) { log.DebugLog()
...
func valueToRangeIndex(indexValue Value, length int64, negativeIsZero bool) int64 { log.DebugLog()
...
func rangeStartEnd(array []Value, size int64, negativeIsZero bool) (start, end int64) { log.DebugLog()
...
func rangeStartLength(source []Value, size int64) (start, length int64) { log.DebugLog()
...
func boolFields(input string) (result map[string]bool) { log.DebugLog()
...
func hereBeDragons(arguments ...interface{}) string { log.DebugLog()
...
func throwHereBeDragons(arguments ...interface{}) { log.DebugLog()
	panic(hereBeDragons(arguments...))
}

func eachPair(list []interface{}, fn func(_0, _1 interface{})) { log.DebugLog()
	for len(list) > 0 {
		var _0, _1 interface{}
		_0 = list[0]
