...
func (otto *Otto) clone() *Otto { log.DebugLog()
	self := &Otto{
...
//
func Run(src interface{}) (*Otto, Value, error) { log.DebugLog()
	otto := New()
...
// src may also be a Program, but if the AST has been modified, then runtime behavior is undefined.
//
func (self Otto) Run(src interface{}) (Value, error) { log.DebugLog()
...
func (self Otto) Eval(src interface{}) (Value, error) { log.DebugLog()
...
// will be undefined.
func (self Otto) Get(name string) (Value, error) { log.DebugLog()
	value := Value{}
	err := catchPanic(func() {
...
func (self Otto) getValue(name string) Value { log.DebugLog()
...
func (self Otto) Set(name string, value interface{}) error { log.DebugLog()
	{
...
func (self Otto) setValue(name string, value Value) { log.DebugLog()
	self.runtime.globalStash.setValue(name, value, false)
}

func (self Otto) SetDebuggerHandler(fn func(vm *Otto)) { log.DebugLog()
	self.runtime.debugger = fn
}

func (self Otto) SetRandomSource(fn func() float64) { log.DebugLog()
...
func (self Otto) SetStackDepthLimit(limit int) { log.DebugLog()
...
func (self Otto) SetStackTraceLimit(limit int) { log.DebugLog()
...
func (self Otto) MakeCustomError(name, message string) Value { log.DebugLog()
...
// returning it as a Value.
func (self Otto) MakeRangeError(message string) Value { log.DebugLog()
...
// returning it as a Value.
func (self Otto) MakeSyntaxError(message string) Value { log.DebugLog()
...
// returning it as a Value.
func (self Otto) MakeTypeError(message string) Value { log.DebugLog()
...
func (self Otto) Context() Context { log.DebugLog()
...
func (self Otto) ContextLimit(limit int) Context { log.DebugLog()
...
func (self Otto) ContextSkip(limit int, skipNative bool) (ctx Context) { log.DebugLog()
...
//
func (self Otto) Call(source string, this interface{}, argumentList ...interface{}) (Value, error) { log.DebugLog()
...
func (self Otto) Object(source string) (*Object, error) { log.DebugLog()
...
func (self Otto) ToValue(value interface{}) (Value, error) { log.DebugLog()
...
func (in *Otto) Copy() *Otto { log.DebugLog()
	out := &Otto{
...
func _newObject(object *_object, value Value) *Object { log.DebugLog()
...
//
func (self Object) Call(name string, argumentList ...interface{}) (Value, error) { log.DebugLog()
...
func (self Object) Value() Value { log.DebugLog()
	return self.value
}

// Get the value of the property with the given name.
func (self Object) Get(name string) (Value, error) { log.DebugLog()
	value := Value{}
	err := catchPanic(func() {
...
func (self Object) Set(name string, value interface{}) error { log.DebugLog()
	{
...
func (self Object) Keys() []string { log.DebugLog()
	var keys []string
...
func (self Object) KeysByParent() [][]string { log.DebugLog()
	var a [][]string
...
//		RegExp
//
func (self Object) Class() string { log.DebugLog()
