...
//      vm.Run(script)
//
func (self *Otto) Compile(filename string, src interface{}) (*Script, error) { log.DebugLog()
...
func (self *Otto) CompileWithSourceMap(filename string, src, sm interface{}) (*Script, error) { log.DebugLog()
...
func (self *Script) String() string { log.DebugLog()
...
//
func (self *Script) marshalBinary() ([]byte, error) { log.DebugLog()
...
// The binary format can change at any time and should be considered unspecified and opaque.
//
func (self *Script) unmarshalBinary(data []byte) error { log.DebugLog()
