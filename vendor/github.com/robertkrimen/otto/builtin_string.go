...
func stringValueFromStringArgumentList(argumentList []Value) Value { log.DebugLog()
...
func builtinString(call FunctionCall) Value { log.DebugLog()
	return stringValueFromStringArgumentList(call.ArgumentList)
}

func builtinNewString(self *_object, argumentList []Value) Value { log.DebugLog()
	return toValue_object(self.runtime.newString(stringValueFromStringArgumentList(argumentList)))
}

func builtinString_toString(call FunctionCall) Value { log.DebugLog()
	return call.thisClassObject("String").primitiveValue()
}
func builtinString_valueOf(call FunctionCall) Value { log.DebugLog()
	return call.thisClassObject("String").primitiveValue()
}

func builtinString_fromCharCode(call FunctionCall) Value { log.DebugLog()
...
func builtinString_charAt(call FunctionCall) Value { log.DebugLog()
...
func builtinString_charCodeAt(call FunctionCall) Value { log.DebugLog()
	checkObjectCoercible(call.runtime, call.This)
	idx := int(call.Argument(0).number().int64)
	chr := stringAt(call.This._object().stringValue(), idx)
	if chr == utf8.RuneError {
...
func builtinString_concat(call FunctionCall) Value { log.DebugLog()
	checkObjectCoercible(call.runtime, call.This)
...
func builtinString_indexOf(call FunctionCall) Value { log.DebugLog()
	checkObjectCoercible(call.runtime, call.This)
...
func builtinString_lastIndexOf(call FunctionCall) Value { log.DebugLog()
	checkObjectCoercible(call.runtime, call.This)
	value := call.This.string()
	target := call.Argument(0).string()
...
func builtinString_match(call FunctionCall) Value { log.DebugLog()
	checkObjectCoercible(call.runtime, call.This)
...
func builtinString_findAndReplaceString(input []byte, lastIndex int, match []int, target []byte, replaceValue []byte) (output []byte) { log.DebugLog()
...
func builtinString_replace(call FunctionCall) Value { log.DebugLog()
	checkObjectCoercible(call.runtime, call.This)
...
func builtinString_search(call FunctionCall) Value { log.DebugLog()
	checkObjectCoercible(call.runtime, call.This)
	target := call.This.string()
	searchValue := call.Argument(0)
...
func stringSplitMatch(target string, targetLength int64, index uint, search string, searchLength int64) (bool, uint) { log.DebugLog()
...
func builtinString_split(call FunctionCall) Value { log.DebugLog()
	checkObjectCoercible(call.runtime, call.This)
	target := call.This.string()
...
func builtinString_slice(call FunctionCall) Value { log.DebugLog()
	checkObjectCoercible(call.runtime, call.This)
	target := call.This.string()
...
func builtinString_substring(call FunctionCall) Value { log.DebugLog()
	checkObjectCoercible(call.runtime, call.This)
	target := call.This.string()
...
func builtinString_substr(call FunctionCall) Value { log.DebugLog()
	target := call.This.string()
...
func builtinString_toLowerCase(call FunctionCall) Value { log.DebugLog()
	checkObjectCoercible(call.runtime, call.This)
	return toValue_string(strings.ToLower(call.This.string()))
}

func builtinString_toUpperCase(call FunctionCall) Value { log.DebugLog()
	checkObjectCoercible(call.runtime, call.This)
...
func builtinString_trim(call FunctionCall) Value { log.DebugLog()
	checkObjectCoercible(call.runtime, call.This)
...
func builtinString_trimLeft(call FunctionCall) Value { log.DebugLog()
	checkObjectCoercible(call.runtime, call.This)
...
// Mozilla extension, not ECMAScript 5
func builtinString_trimRight(call FunctionCall) Value { log.DebugLog()
	checkObjectCoercible(call.runtime, call.This)
	return toValue(strings.TrimRight(call.This.string(),
		builtinString_trim_whitespace))
}

func builtinString_localeCompare(call FunctionCall) Value { log.DebugLog()
	checkObjectCoercible(call.runtime, call.This)
...
func builtinString_toLocaleLowerCase(call FunctionCall) Value { log.DebugLog()
	return builtinString_toLowerCase(call)
}

func builtinString_toLocaleUpperCase(call FunctionCall) Value { log.DebugLog()
