...
func (self *_parser) parseIdentifier() *ast.Identifier { log.DebugLog()
...
func (self *_parser) parsePrimaryExpression() ast.Expression { log.DebugLog()
	literal := self.literal
	idx := self.idx
	switch self.token {
...
func (self *_parser) parseRegExpLiteral() *ast.RegExpLiteral { log.DebugLog()
...
func (self *_parser) parseVariableDeclaration(declarationList *[]*ast.VariableExpression) ast.Expression { log.DebugLog()
...
func (self *_parser) parseVariableDeclarationList(var_ file.Idx) []ast.Expression { log.DebugLog()
...
func (self *_parser) parseObjectPropertyKey() (string, string) { log.DebugLog()
...
func (self *_parser) parseObjectProperty() ast.Property { log.DebugLog()
...
func (self *_parser) parseObjectLiteral() ast.Expression { log.DebugLog()
...
func (self *_parser) parseArrayLiteral() ast.Expression { log.DebugLog()
...
func (self *_parser) parseArgumentList() (argumentList []ast.Expression, idx0, idx1 file.Idx) { log.DebugLog()
	if self.mode&StoreComments != 0 {
		self.comments.Unset()
	}
...
func (self *_parser) parseCallExpression(left ast.Expression) ast.Expression { log.DebugLog()
...
func (self *_parser) parseDotMember(left ast.Expression) ast.Expression { log.DebugLog()
...
func (self *_parser) parseBracketMember(left ast.Expression) ast.Expression { log.DebugLog()
	idx0 := self.expect(token.LEFT_BRACKET)
...
func (self *_parser) parseNewExpression() ast.Expression { log.DebugLog()
...
func (self *_parser) parseLeftHandSideExpression() ast.Expression { log.DebugLog()
...
func (self *_parser) parseLeftHandSideExpressionAllowCall() ast.Expression { log.DebugLog()
...
func (self *_parser) parsePostfixExpression() ast.Expression { log.DebugLog()
...
func (self *_parser) parseUnaryExpression() ast.Expression { log.DebugLog()
...
func (self *_parser) parseMultiplicativeExpression() ast.Expression { log.DebugLog()
...
func (self *_parser) parseAdditiveExpression() ast.Expression { log.DebugLog()
...
func (self *_parser) parseShiftExpression() ast.Expression { log.DebugLog()
...
func (self *_parser) parseRelationalExpression() ast.Expression { log.DebugLog()
...
func (self *_parser) parseEqualityExpression() ast.Expression { log.DebugLog()
...
func (self *_parser) parseBitwiseAndExpression() ast.Expression { log.DebugLog()
...
func (self *_parser) parseBitwiseExclusiveOrExpression() ast.Expression { log.DebugLog()
...
func (self *_parser) parseBitwiseOrExpression() ast.Expression { log.DebugLog()
...
func (self *_parser) parseLogicalAndExpression() ast.Expression { log.DebugLog()
...
func (self *_parser) parseLogicalOrExpression() ast.Expression { log.DebugLog()
...
func (self *_parser) parseConditionlExpression() ast.Expression { log.DebugLog()
...
func (self *_parser) parseAssignmentExpression() ast.Expression { log.DebugLog()
...
func (self *_parser) parseExpression() ast.Expression { log.DebugLog()
