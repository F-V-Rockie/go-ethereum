...
func newContext() *_runtime { log.DebugLog()
...
func (runtime *_runtime) newBaseObject() *_object { log.DebugLog()
	self := newObject(runtime, "")
	return self
}

func (runtime *_runtime) newClassObject(class string) *_object { log.DebugLog()
	return newObject(runtime, class)
}

func (runtime *_runtime) newPrimitiveObject(class string, value Value) *_object { log.DebugLog()
	self := runtime.newClassObject(class)
	self.value = value
	return self
}

func (self *_object) primitiveValue() Value { log.DebugLog()
...
func (self *_object) hasPrimitive() bool { log.DebugLog()
...
func (runtime *_runtime) newObject() *_object { log.DebugLog()
	self := runtime.newClassObject("Object")
	self.prototype = runtime.global.ObjectPrototype
	return self
}

func (runtime *_runtime) newArray(length uint32) *_object { log.DebugLog()
	self := runtime.newArrayObject(length)
	self.prototype = runtime.global.ArrayPrototype
	return self
}

func (runtime *_runtime) newArrayOf(valueArray []Value) *_object { log.DebugLog()
...
func (runtime *_runtime) newString(value Value) *_object { log.DebugLog()
	self := runtime.newStringObject(value)
	self.prototype = runtime.global.StringPrototype
	return self
}

func (runtime *_runtime) newBoolean(value Value) *_object { log.DebugLog()
	self := runtime.newBooleanObject(value)
	self.prototype = runtime.global.BooleanPrototype
	return self
}

func (runtime *_runtime) newNumber(value Value) *_object { log.DebugLog()
	self := runtime.newNumberObject(value)
	self.prototype = runtime.global.NumberPrototype
	return self
}

func (runtime *_runtime) newRegExp(patternValue Value, flagsValue Value) *_object { log.DebugLog()
...
func (runtime *_runtime) _newRegExp(pattern string, flags string) *_object { log.DebugLog()
...
func (runtime *_runtime) newDate(epoch float64) *_object { log.DebugLog()
	self := runtime.newDateObject(epoch)
	self.prototype = runtime.global.DatePrototype
	return self
}

func (runtime *_runtime) newError(name string, message Value, stackFramesToPop int) *_object { log.DebugLog()
	var self *_object
	switch name {
	case "EvalError":
...
func (runtime *_runtime) newNativeFunction(name, file string, line int, _nativeFunction _nativeFunction) *_object { log.DebugLog()
...
func (runtime *_runtime) newNodeFunction(node *_nodeFunctionLiteral, scopeEnvironment _stash) *_object { log.DebugLog()
...
func (runtime *_runtime) newBoundFunction(target *_object, this Value, argumentList []Value) *_object { log.DebugLog()
