...
func (cfg *Config) Marshal(v interface{}) ([]byte, error) { log.DebugLog()
...
func (cfg *Config) NewEncoder(w io.Writer) *Encoder { log.DebugLog()
...
func (e *Encoder) Encode(v interface{}) error { log.DebugLog()
...
func (b *tableBuf) writeTo(w io.Writer, prefix string) error { log.DebugLog()
...
func (b *tableBuf) newChild(name string) *tableBuf { log.DebugLog()
...
func (b *tableBuf) addChild(child *tableBuf) { log.DebugLog()
...
func (b *tableBuf) structFields(cfg *Config, rv reflect.Value) error { log.DebugLog()
	rt := rv.Type()
...
func (l mapKeyList) Len() int           { log.DebugLog() return len(l) }
func (l mapKeyList) Swap(i, j int)      { log.DebugLog() l[i], l[j] = l[j], l[i] }
func (l mapKeyList) Less(i, j int) bool { log.DebugLog() return l[i].key < l[j].key }

func (b *tableBuf) mapFields(cfg *Config, rv reflect.Value) error { log.DebugLog()
	keys := rv.MapKeys()
...
func (b *tableBuf) field(cfg *Config, name string, rv reflect.Value) error { log.DebugLog()
	off := len(b.body)
...
func (b *tableBuf) value(cfg *Config, rv reflect.Value, name string) (bool, error) { log.DebugLog()
...
func (b *tableBuf) marshaler(cfg *Config, rv reflect.Value, name string) (handled, isTable bool, err error) { log.DebugLog()
...
func encodeTextMarshaler(buf []byte, v string) []byte { log.DebugLog()
...
func encodeMapKey(rv reflect.Value) (string, error) { log.DebugLog()
...
func isEmptyValue(v reflect.Value) bool { log.DebugLog()
	switch v.Kind() {
	case reflect.Array:
...
func quoteName(s string) string { log.DebugLog()
	if len(s) == 0 {
