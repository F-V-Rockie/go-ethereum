...
func (k *kq) Stop() (err error) { log.DebugLog()
...
func (k *kq) Close() error { log.DebugLog()
	return syscall.Close(k.fd)
}

// NewWatched implements trigger.
func (*kq) NewWatched(p string, fi os.FileInfo) (*watched, error) { log.DebugLog()
...
func (k *kq) Record(w *watched) { log.DebugLog()
	k.idLkp[w.fd], k.pthLkp[w.p] = w, w
}

// Del implements trigger.
func (k *kq) Del(w *watched) { log.DebugLog()
	syscall.Close(w.fd)
	delete(k.idLkp, w.fd)
	delete(k.pthLkp, w.p)
}

func inter2kq(n interface{}) syscall.Kevent_t { log.DebugLog()
...
func (k *kq) Init() (err error) { log.DebugLog()
...
func (k *kq) Unwatch(w *watched) (err error) { log.DebugLog()
	var kevn [1]syscall.Kevent_t
...
func (k *kq) Watch(fi os.FileInfo, w *watched, e int64) (err error) { log.DebugLog()
	var kevn [1]syscall.Kevent_t
...
func (k *kq) Wait() (interface{}, error) { log.DebugLog()
	var (
...
func (k *kq) Watched(n interface{}) (*watched, int64, error) { log.DebugLog()
...
func (k *kq) IsStop(n interface{}, err error) bool { log.DebugLog()
