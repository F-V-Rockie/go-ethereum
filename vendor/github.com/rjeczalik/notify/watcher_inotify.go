...
func (i *inotify) Watch(path string, e Event) error { log.DebugLog()
	return i.watch(path, e)
}

// Rewatch implements notify.watcher interface.
func (i *inotify) Rewatch(path string, _, newevent Event) error { log.DebugLog()
...
func (i *inotify) watch(path string, e Event) (err error) { log.DebugLog()
...
func (i *inotify) lazyinit() error { log.DebugLog()
...
func (i *inotify) epollinit() (err error) { log.DebugLog()
...
func (i *inotify) epollclose() (err error) { log.DebugLog()
...
func (i *inotify) loop(esch chan<- []*event) { log.DebugLog()
...
func (i *inotify) read() (es []*event) { log.DebugLog()
...
func (i *inotify) send(esch <-chan []*event) { log.DebugLog()
	for es := range esch {
...
func (i *inotify) transform(es []*event) []*event { log.DebugLog()
	var multi []*event
	i.RLock()
	for idx, e := range es {
...
func encode(e Event) uint32 { log.DebugLog()
	if e&Create != 0 {
...
func decode(mask Event, e *event) (syse *event) { log.DebugLog()
...
func (i *inotify) Unwatch(path string) (err error) { log.DebugLog()
...
func (i *inotify) Close() (err error) { log.DebugLog()
	i.Lock()
...
func removeInotifyWatch(fd int32, iwd int32) (err error) { log.DebugLog()
