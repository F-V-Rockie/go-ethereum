...
func splitflags(set uint32) (e []uint32) { log.DebugLog()
...
//
func (w *watch) strip(base string, set uint32) uint32 { log.DebugLog()
	const (
...
func (w *watch) Dispatch(ev []FSEvent) { log.DebugLog()
...
func (w *watch) Stop() { log.DebugLog()
	w.stream.Stop()
...
func (fse *fsevents) watch(path string, event Event, isrec int32) (err error) { log.DebugLog()
...
func (fse *fsevents) unwatch(path string) (err error) { log.DebugLog()
...
func (fse *fsevents) Watch(path string, event Event) error { log.DebugLog()
...
func (fse *fsevents) Unwatch(path string) error { log.DebugLog()
...
func (fse *fsevents) Rewatch(path string, oldevent, newevent Event) error { log.DebugLog()
	w, ok := fse.watches[path]
	if !ok {
		return errNotWatched
	}
...
func (fse *fsevents) RecursiveWatch(path string, event Event) error { log.DebugLog()
...
func (fse *fsevents) RecursiveUnwatch(path string) error { log.DebugLog()
	return fse.unwatch(path)
}
...
// that follows.
func (fse *fsevents) RecursiveRewatch(oldpath, newpath string, oldevent, newevent Event) error { log.DebugLog()
...
func (fse *fsevents) Close() error { log.DebugLog()
