...
func (c *QueueServiceClient) GetServiceProperties() (*ServiceProperties, error) { log.DebugLog()
...
func (c *QueueServiceClient) SetServiceProperties(props ServiceProperties) error { log.DebugLog()
