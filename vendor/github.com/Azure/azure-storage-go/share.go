...
func (s *Share) buildPath() string { log.DebugLog()
...
func (s *Share) Create() error { log.DebugLog()
...
//
// See https://msdn.microsoft.com/en-us/library/azure/dn167008.aspx
func (s *Share) CreateIfNotExists() (bool, error) { log.DebugLog()
...
func (s *Share) Delete() error { log.DebugLog()
...
//
// See https://msdn.microsoft.com/en-us/library/azure/dn689090.aspx
func (s *Share) DeleteIfExists() (bool, error) { log.DebugLog()
...
func (s *Share) Exists() (bool, error) { log.DebugLog()
...
func (s *Share) FetchAttributes() error { log.DebugLog()
...
func (s *Share) GetRootDirectoryReference() *Directory { log.DebugLog()
	return &Directory{
		fsc:   s.fsc,
		share: s,
	}
...
func (s *Share) ServiceClient() *FileServiceClient { log.DebugLog()
	return s.fsc
}
...
func (s *Share) SetMetadata() error { log.DebugLog()
...
func (s *Share) SetProperties() error { log.DebugLog()
...
func (s *Share) updateEtagAndLastModified(headers http.Header) { log.DebugLog()
	s.Properties.Etag = headers.Get("Etag")
	s.Properties.LastModified = headers.Get("Last-Modified")
}

// updates quota value
func (s *Share) updateQuota(headers http.Header) { log.DebugLog()
...
func (s *Share) URL() string { log.DebugLog()
