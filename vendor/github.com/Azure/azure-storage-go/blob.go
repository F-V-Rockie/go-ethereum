...
func (bm *BlobMetadata) UnmarshalXML(d *xml.Decoder, start xml.StartElement) error { log.DebugLog()
...
// ListBlobs response.
func (bm BlobMetadata) MarshalXML(enc *xml.Encoder, start xml.StartElement) error { log.DebugLog()
...
func (b BlobStorageClient) BlobExists(container, name string) (bool, error) { log.DebugLog()
...
func (b BlobStorageClient) GetBlobURL(container, name string) string { log.DebugLog()
	if container == "" {
		container = "$root"
	}
...
func (b BlobStorageClient) GetBlob(container, name string) (io.ReadCloser, error) { log.DebugLog()
...
//
// See https://msdn.microsoft.com/en-us/library/azure/dd179440.aspx
func (b BlobStorageClient) GetBlobRange(container, name, bytesRange string, extraHeaders map[string]string) (io.ReadCloser, error) { log.DebugLog()
...
func (b BlobStorageClient) getBlobRange(container, name, bytesRange string, extraHeaders map[string]string) (*storageResponse, error) { log.DebugLog()
	uri := b.client.getEndpoint(blobServiceName, pathForBlob(container, name), url.Values{})
...
func (b BlobStorageClient) leaseCommonPut(container string, name string, headers map[string]string, expectedStatus int) (http.Header, error) { log.DebugLog()
...
func (b BlobStorageClient) SnapshotBlob(container string, name string, timeout int, extraHeaders map[string]string) (snapshotTimestamp *time.Time, err error) { log.DebugLog()
	extraHeaders = b.client.protectUserAgent(extraHeaders)
	headers := b.client.getStandardHeaders()
...
func (b BlobStorageClient) AcquireLease(container string, name string, leaseTimeInSeconds int, proposedLeaseID string) (returnedLeaseID string, err error) { log.DebugLog()
	headers := b.client.getStandardHeaders()
...
func (b BlobStorageClient) BreakLease(container string, name string) (breakTimeout int, err error) { log.DebugLog()
	headers := b.client.getStandardHeaders()
...
// Returns the timeout remaining in the lease in seconds
func (b BlobStorageClient) BreakLeaseWithBreakPeriod(container string, name string, breakPeriodInSeconds int) (breakTimeout int, err error) { log.DebugLog()
	headers := b.client.getStandardHeaders()
	headers[leaseAction] = breakLease
...
func (b BlobStorageClient) breakLeaseCommon(container string, name string, headers map[string]string) (breakTimeout int, err error) { log.DebugLog()
...
func (b BlobStorageClient) ChangeLease(container string, name string, currentLeaseID string, proposedLeaseID string) (newLeaseID string, err error) { log.DebugLog()
	headers := b.client.getStandardHeaders()
...
func (b BlobStorageClient) ReleaseLease(container string, name string, currentLeaseID string) error { log.DebugLog()
	headers := b.client.getStandardHeaders()
...
func (b BlobStorageClient) RenewLease(container string, name string, currentLeaseID string) error { log.DebugLog()
	headers := b.client.getStandardHeaders()
...
func (b BlobStorageClient) GetBlobProperties(container, name string) (*BlobProperties, error) { log.DebugLog()
	uri := b.client.getEndpoint(blobServiceName, pathForBlob(container, name), url.Values{})
...
func (b BlobStorageClient) SetBlobProperties(container, name string, blobHeaders BlobHeaders) error { log.DebugLog()
...
func (b BlobStorageClient) SetBlobMetadata(container, name string, metadata map[string]string, extraHeaders map[string]string) error { log.DebugLog()
...
//
// See https://msdn.microsoft.com/en-us/library/azure/dd179414.aspx
func (b BlobStorageClient) GetBlobMetadata(container, name string) (map[string]string, error) { log.DebugLog()
	params := url.Values{"comp": {"metadata"}}
	uri := b.client.getEndpoint(blobServiceName, pathForBlob(container, name), params)
	headers := b.client.getStandardHeaders()
...
func (b BlobStorageClient) CreateBlockBlob(container, name string) error { log.DebugLog()
...
//
// See https://msdn.microsoft.com/en-us/library/azure/dd179451.aspx
func (b BlobStorageClient) CreateBlockBlobFromReader(container, name string, size uint64, blob io.Reader, extraHeaders map[string]string) error { log.DebugLog()
...
func (b BlobStorageClient) PutBlock(container, name, blockID string, chunk []byte) error { log.DebugLog()
...
//
// See https://msdn.microsoft.com/en-us/library/azure/dd135726.aspx
func (b BlobStorageClient) PutBlockWithLength(container, name, blockID string, size uint64, blob io.Reader, extraHeaders map[string]string) error { log.DebugLog()
...
func (b BlobStorageClient) PutBlockList(container, name string, blocks []Block) error { log.DebugLog()
...
//
// See https://msdn.microsoft.com/en-us/library/azure/dd179400.aspx
func (b BlobStorageClient) GetBlockList(container, name string, blockType BlockListType) (BlockListResponse, error) { log.DebugLog()
...
//
// See https://msdn.microsoft.com/en-us/library/azure/dd179451.aspx
func (b BlobStorageClient) PutPageBlob(container, name string, size int64, extraHeaders map[string]string) error { log.DebugLog()
	path := fmt.Sprintf("%s/%s", container, name)
	uri := b.client.getEndpoint(blobServiceName, path, url.Values{})
	extraHeaders = b.client.protectUserAgent(extraHeaders)
	headers := b.client.getStandardHeaders()
...
func (b BlobStorageClient) PutPage(container, name string, startByte, endByte int64, writeType PageWriteType, chunk []byte, extraHeaders map[string]string) error { log.DebugLog()
	path := fmt.Sprintf("%s/%s", container, name)
...
//
// See https://msdn.microsoft.com/en-us/library/azure/ee691973.aspx
func (b BlobStorageClient) GetPageRanges(container, name string) (GetPageRangesResponse, error) { log.DebugLog()
	path := fmt.Sprintf("%s/%s", container, name)
...
//
// See https://msdn.microsoft.com/en-us/library/azure/dd179451.aspx
func (b BlobStorageClient) PutAppendBlob(container, name string, extraHeaders map[string]string) error { log.DebugLog()
	path := fmt.Sprintf("%s/%s", container, name)
	uri := b.client.getEndpoint(blobServiceName, path, url.Values{})
	extraHeaders = b.client.protectUserAgent(extraHeaders)
	headers := b.client.getStandardHeaders()
...
func (b BlobStorageClient) AppendBlock(container, name string, chunk []byte, extraHeaders map[string]string) error { log.DebugLog()
	path := fmt.Sprintf("%s/%s", container, name)
...
func (b BlobStorageClient) CopyBlob(container, name, sourceBlob string) error { log.DebugLog()
...
//
// See https://msdn.microsoft.com/en-us/library/azure/dd894037.aspx
func (b BlobStorageClient) StartBlobCopy(container, name, sourceBlob string) (string, error) { log.DebugLog()
	uri := b.client.getEndpoint(blobServiceName, pathForBlob(container, name), url.Values{})
...
func (b BlobStorageClient) AbortBlobCopy(container, name, copyID, currentLeaseID string, timeout int) error { log.DebugLog()
...
func (b BlobStorageClient) WaitForBlobCopy(container, name, copyID string) error { log.DebugLog()
	for {
...
func (b BlobStorageClient) DeleteBlob(container, name string, extraHeaders map[string]string) error { log.DebugLog()
...
func (b BlobStorageClient) DeleteBlobIfExists(container, name string, extraHeaders map[string]string) (bool, error) { log.DebugLog()
	resp, err := b.deleteBlob(container, name, extraHeaders)
	if resp != nil {
		defer readAndCloseBody(resp.body)
...
func (b BlobStorageClient) deleteBlob(container, name string, extraHeaders map[string]string) (*storageResponse, error) { log.DebugLog()
	uri := b.client.getEndpoint(blobServiceName, pathForBlob(container, name), url.Values{})
	extraHeaders = b.client.protectUserAgent(extraHeaders)
	headers := b.client.getStandardHeaders()
	for k, v := range extraHeaders {
...
// name
func pathForBlob(container, name string) string { log.DebugLog()
	return fmt.Sprintf("/%s/%s", container, name)
}

// helper method to construct the path to either a blob or container
func pathForResource(container, name string) string { log.DebugLog()
	if len(name) > 0 {
		return fmt.Sprintf("/%s/%s", container, name)
	}
...
func (b BlobStorageClient) GetBlobSASURIWithSignedIPAndProtocol(container, name string, expiry time.Time, permissions string, signedIPRange string, HTTPSOnly bool) (string, error) { log.DebugLog()
	var (
...
//
// See https://msdn.microsoft.com/en-us/library/azure/ee395415.aspx
func (b BlobStorageClient) GetBlobSASURI(container, name string, expiry time.Time, permissions string) (string, error) { log.DebugLog()
	url, err := b.GetBlobSASURIWithSignedIPAndProtocol(container, name, expiry, permissions, "", false)
	return url, err
}

func blobSASStringToSign(signedVersion, canonicalizedResource, signedExpiry, signedPermissions string, signedIP string, protocols string) (string, error) { log.DebugLog()
