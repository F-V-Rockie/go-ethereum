...
func pathForQueue(queue string) string         { log.DebugLog() return fmt.Sprintf("/%s", queue) }
func pathForQueueMessages(queue string) string { log.DebugLog() return fmt.Sprintf("/%s/messages", queue) }
func pathForMessage(queue, name string) string { log.DebugLog() return fmt.Sprintf("/%s/messages/%s", queue, name) }
...
func (p PutMessageParameters) getParameters() url.Values { log.DebugLog()
	out := url.Values{}
...
func (p GetMessagesParameters) getParameters() url.Values { log.DebugLog()
	out := url.Values{}
...
func (p PeekMessagesParameters) getParameters() url.Values { log.DebugLog()
...
func (p UpdateMessageParameters) getParameters() url.Values { log.DebugLog()
	out := url.Values{}
	if p.PopReceipt != "" {
...
func (c QueueServiceClient) SetMetadata(name string, metadata map[string]string) error { log.DebugLog()
...
// be all lower case.
func (c QueueServiceClient) GetMetadata(name string) (QueueMetadataResponse, error) { log.DebugLog()
...
func (c QueueServiceClient) CreateQueue(name string) error { log.DebugLog()
...
func (c QueueServiceClient) DeleteQueue(name string) error { log.DebugLog()
	uri := c.client.getEndpoint(queueServiceName, pathForQueue(name), url.Values{})
...
func (c QueueServiceClient) QueueExists(name string) (bool, error) { log.DebugLog()
...
func (c QueueServiceClient) PutMessage(queue string, message string, params PutMessageParameters) error { log.DebugLog()
...
func (c QueueServiceClient) ClearMessages(queue string) error { log.DebugLog()
...
func (c QueueServiceClient) GetMessages(queue string, params GetMessagesParameters) (GetMessagesResponse, error) { log.DebugLog()
...
func (c QueueServiceClient) PeekMessages(queue string, params PeekMessagesParameters) (PeekMessagesResponse, error) { log.DebugLog()
...
func (c QueueServiceClient) DeleteMessage(queue, messageID, popReceipt string) error { log.DebugLog()
...
func (c QueueServiceClient) UpdateMessage(queue string, messageID string, message string, params UpdateMessageParameters) error { log.DebugLog()
