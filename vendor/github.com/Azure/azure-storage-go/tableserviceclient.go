...
func (c *TableServiceClient) GetServiceProperties() (*ServiceProperties, error) { log.DebugLog()
...
func (c *TableServiceClient) SetServiceProperties(props ServiceProperties) error { log.DebugLog()
