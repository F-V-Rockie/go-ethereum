...
func TermWidth() int { log.DebugLog()
	termSync()
	return termWidth
}

// TermHeight returns the current terminal's height.
func TermHeight() int { log.DebugLog()
	termSync()
	return termHeight
}
...
func render(bs ...Bufferer) { log.DebugLog()
	defer func() {
		if e := recover(); e != nil {
			Close()
...
func clearArea(r image.Rectangle, bg Attribute) { log.DebugLog()
