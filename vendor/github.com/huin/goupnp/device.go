...
func (root *RootDevice) SetURLBase(urlBase *url.URL) { log.DebugLog()
...
func (device *Device) VisitDevices(visitor func(*Device)) { log.DebugLog()
	visitor(device)
...
// descendent devices.
func (device *Device) VisitServices(visitor func(*Service)) { log.DebugLog()
...
func (device *Device) FindService(serviceType string) []*Service { log.DebugLog()
...
func (device *Device) SetURLBase(urlBase *url.URL) { log.DebugLog()
...
func (device *Device) String() string { log.DebugLog()
...
func (icon *Icon) SetURLBase(url *url.URL) { log.DebugLog()
...
func (srv *Service) SetURLBase(urlBase *url.URL) { log.DebugLog()
	srv.SCPDURL.SetURLBase(urlBase)
	srv.ControlURL.SetURLBase(urlBase)
	srv.EventSubURL.SetURLBase(urlBase)
}

func (srv *Service) String() string { log.DebugLog()
...
// for the service.
func (srv *Service) RequestSCDP() (*scpd.SCPD, error) { log.DebugLog()
	if !srv.SCPDURL.Ok {
...
func (srv *Service) NewSOAPClient() *soap.SOAPClient { log.DebugLog()
...
func (uf *URLField) SetURLBase(urlBase *url.URL) { log.DebugLog()
