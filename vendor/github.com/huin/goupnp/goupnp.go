...
func (err ContextError) Error() string { log.DebugLog()
...
func DiscoverDevices(searchTarget string) ([]MaybeRootDevice, error) { log.DebugLog()
...
func DeviceByURL(loc *url.URL) (*RootDevice, error) { log.DebugLog()
	locStr := loc.String()
	root := new(RootDevice)
...
func requestXml(url string, defaultSpace string, doc interface{}) error { log.DebugLog()
