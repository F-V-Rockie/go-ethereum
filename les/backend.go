...
func (s *LightEthereum) BlockChain() *light.LightChain      { log.DebugLog()
																return s.blockchain }
func (s *LightEthereum) TxPool() *light.TxPool              { log.DebugLog()
																return s.txPool }
func (s *LightEthereum) Engine() consensus.Engine           { log.DebugLog()
																return s.engine }
func (s *LightEthereum) LesVersion() int                    { log.DebugLog()
																return int(s.protocolManager.SubProtocols[0].Version) }
func (s *LightEthereum) Downloader() *downloader.Downloader { log.DebugLog()
																return s.protocolManager.downloader }
func (s *LightEthereum) EventMux() *event.TypeMux           { log.DebugLog()
																return s.eventMux }
