...
func GetHeaderByNumber(ctx context.Context, odr OdrBackend, number uint64) (*types.Header, error) { log.DebugLog()
	db := odr.Database()
...
func GetCanonicalHash(ctx context.Context, odr OdrBackend, number uint64) (common.Hash, error) { log.DebugLog()
...
func GetBodyRLP(ctx context.Context, odr OdrBackend, hash common.Hash, number uint64) (rlp.RawValue, error) { log.DebugLog()
...
// hash.
func GetBody(ctx context.Context, odr OdrBackend, hash common.Hash, number uint64) (*types.Body, error) { log.DebugLog()
...
func GetBlock(ctx context.Context, odr OdrBackend, hash common.Hash, number uint64) (*types.Block, error) { log.DebugLog()
...
func GetBlockReceipts(ctx context.Context, odr OdrBackend, hash common.Hash, number uint64) (types.Receipts, error) { log.DebugLog()
...
func GetBlockLogs(ctx context.Context, odr OdrBackend, hash common.Hash, number uint64) ([][]*types.Log, error) { log.DebugLog()
	// Retrieve the potentially incomplete receipts from disk or network
	receipts := core.GetBlockReceipts(odr.Database(), hash, number)
	if receipts == nil {
		r := &ReceiptsRequest{Hash: hash, Number: number}
...
func GetBloomBits(ctx context.Context, odr OdrBackend, bitIdx uint, sectionIdxList []uint64) ([][]byte, error) { log.DebugLog()
	db := odr.Database()
