...
func NewEthereumClient(rawurl string) (client *EthereumClient, _ error) { log.DebugLog()
	rawClient, err := ethclient.Dial(rawurl)
	return &EthereumClient{rawClient}, err
}

// GetBlockByHash returns the given full block.
func (ec *EthereumClient) GetBlockByHash(ctx *Context, hash *Hash) (block *Block, _ error) { log.DebugLog()
...
func (ec *EthereumClient) GetBlockByNumber(ctx *Context, number int64) (block *Block, _ error) { log.DebugLog()
	if number < 0 {
...
func (ec *EthereumClient) GetHeaderByHash(ctx *Context, hash *Hash) (header *Header, _ error) { log.DebugLog()
...
func (ec *EthereumClient) GetHeaderByNumber(ctx *Context, number int64) (header *Header, _ error) { log.DebugLog()
	if number < 0 {
...
func (ec *EthereumClient) GetTransactionByHash(ctx *Context, hash *Hash) (tx *Transaction, _ error) { log.DebugLog()
...
func (ec *EthereumClient) GetTransactionSender(ctx *Context, tx *Transaction, blockhash *Hash, index int) (sender *Address, _ error) { log.DebugLog()
...
func (ec *EthereumClient) GetTransactionCount(ctx *Context, hash *Hash) (count int, _ error) { log.DebugLog()
...
func (ec *EthereumClient) GetTransactionInBlock(ctx *Context, hash *Hash, index int) (tx *Transaction, _ error) { log.DebugLog()
...
func (ec *EthereumClient) GetTransactionReceipt(ctx *Context, hash *Hash) (receipt *Receipt, _ error) { log.DebugLog()
...
func (ec *EthereumClient) SyncProgress(ctx *Context) (progress *SyncProgress, _ error) { log.DebugLog()
...
func (ec *EthereumClient) SubscribeNewHead(ctx *Context, handler NewHeadHandler, buffer int) (sub *Subscription, _ error) { log.DebugLog()
...
func (ec *EthereumClient) GetBalanceAt(ctx *Context, account *Address, number int64) (balance *BigInt, _ error) { log.DebugLog()
	if number < 0 {
...
func (ec *EthereumClient) GetStorageAt(ctx *Context, account *Address, key *Hash, number int64) (storage []byte, _ error) { log.DebugLog()
	if number < 0 {
...
func (ec *EthereumClient) GetCodeAt(ctx *Context, account *Address, number int64) (code []byte, _ error) { log.DebugLog()
	if number < 0 {
...
func (ec *EthereumClient) GetNonceAt(ctx *Context, account *Address, number int64) (nonce int64, _ error) { log.DebugLog()
	if number < 0 {
...
func (ec *EthereumClient) FilterLogs(ctx *Context, query *FilterQuery) (logs *Logs, _ error) { log.DebugLog()
...
func (ec *EthereumClient) SubscribeFilterLogs(ctx *Context, query *FilterQuery, handler FilterLogsHandler, buffer int) (sub *Subscription, _ error) { log.DebugLog()
	// Subscribe to the event internally
...
func (ec *EthereumClient) GetPendingBalanceAt(ctx *Context, account *Address) (balance *BigInt, _ error) { log.DebugLog()
...
func (ec *EthereumClient) GetPendingStorageAt(ctx *Context, account *Address, key *Hash) (storage []byte, _ error) { log.DebugLog()
...
func (ec *EthereumClient) GetPendingCodeAt(ctx *Context, account *Address) (code []byte, _ error) { log.DebugLog()
...
func (ec *EthereumClient) GetPendingNonceAt(ctx *Context, account *Address) (nonce int64, _ error) { log.DebugLog()
...
func (ec *EthereumClient) GetPendingTransactionCount(ctx *Context) (count int, _ error) { log.DebugLog()
...
func (ec *EthereumClient) CallContract(ctx *Context, msg *CallMsg, number int64) (output []byte, _ error) { log.DebugLog()
	if number < 0 {
...
func (ec *EthereumClient) PendingCallContract(ctx *Context, msg *CallMsg) (output []byte, _ error) { log.DebugLog()
	return ec.client.PendingCallContract(ctx.context, msg.msg)
}

// SuggestGasPrice retrieves the currently suggested gas price to allow a timely
// execution of a transaction.
func (ec *EthereumClient) SuggestGasPrice(ctx *Context) (price *BigInt, _ error) { log.DebugLog()
...
func (ec *EthereumClient) EstimateGas(ctx *Context, msg *CallMsg) (gas int64, _ error) { log.DebugLog()
...
func (ec *EthereumClient) SendTransaction(ctx *Context, tx *Transaction) error { log.DebugLog()
