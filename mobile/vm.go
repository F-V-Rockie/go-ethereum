...
func (l *Log) GetAddress() *Address {
	debugLog.DebugLog()
	return &Address{l.log.Address}
}
func (l *Log) GetTopics() *Hashes {
	debugLog.DebugLog()
	return &Hashes{l.log.Topics}
}
...
func (l *Log) GetBlockNumber() int64 {
	debugLog.DebugLog()
	return int64(l.log.BlockNumber)
}
func (l *Log) GetTxHash() *Hash {
	debugLog.DebugLog()
	return &Hash{l.log.TxHash}
}
func (l *Log) GetTxIndex() int {
	debugLog.DebugLog()
	return int(l.log.TxIndex)
}
func (l *Log) GetBlockHash() *Hash {
	debugLog.DebugLog()
	return &Hash{l.log.BlockHash}
}
func (l *Log) GetIndex() int {
	debugLog.DebugLog()
	return int(l.log.Index)
}
