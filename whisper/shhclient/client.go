...
func (sc *Client) Version(ctx context.Context) (string, error) { log.DebugLog()
	var result string
...
func (sc *Client) Info(ctx context.Context) (whisper.Info, error) { log.DebugLog()
...
func (sc *Client) SetMaxMessageSize(ctx context.Context, size uint32) error { log.DebugLog()
	var ignored bool
...
func (sc *Client) SetMinimumPoW(ctx context.Context, pow float64) error { log.DebugLog()
	var ignored bool
...
func (sc *Client) MarkTrustedPeer(ctx context.Context, enode string) error { log.DebugLog()
	var ignored bool
...
func (sc *Client) NewKeyPair(ctx context.Context) (string, error) { log.DebugLog()
	var id string
	return id, sc.c.CallContext(ctx, &id, "shh_newKeyPair")
}

// AddPrivateKey stored the key pair, and returns its ID.
func (sc *Client) AddPrivateKey(ctx context.Context, key []byte) (string, error) { log.DebugLog()
	var id string
	return id, sc.c.CallContext(ctx, &id, "shh_addPrivateKey", hexutil.Bytes(key))
}

// DeleteKeyPair delete the specifies key.
func (sc *Client) DeleteKeyPair(ctx context.Context, id string) (string, error) { log.DebugLog()
	var ignored bool
...
func (sc *Client) HasKeyPair(ctx context.Context, id string) (bool, error) { log.DebugLog()
	var has bool
	return has, sc.c.CallContext(ctx, &has, "shh_hasKeyPair", id)
}

// PublicKey return the public key for a key ID.
func (sc *Client) PublicKey(ctx context.Context, id string) ([]byte, error) { log.DebugLog()
...
func (sc *Client) PrivateKey(ctx context.Context, id string) ([]byte, error) { log.DebugLog()
	var key hexutil.Bytes
...
func (sc *Client) NewSymmetricKey(ctx context.Context) (string, error) { log.DebugLog()
	var id string
	return id, sc.c.CallContext(ctx, &id, "shh_newSymKey")
}

// AddSymmetricKey stores the key, and returns its identifier.
func (sc *Client) AddSymmetricKey(ctx context.Context, key []byte) (string, error) { log.DebugLog()
	var id string
...
func (sc *Client) GenerateSymmetricKeyFromPassword(ctx context.Context, passwd []byte) (string, error) { log.DebugLog()
	var id string
...
func (sc *Client) HasSymmetricKey(ctx context.Context, id string) (bool, error) { log.DebugLog()
	var found bool
...
func (sc *Client) GetSymmetricKey(ctx context.Context, id string) ([]byte, error) { log.DebugLog()
	var key hexutil.Bytes
...
func (sc *Client) DeleteSymmetricKey(ctx context.Context, id string) error { log.DebugLog()
	var ignored bool
	return sc.c.CallContext(ctx, &ignored, "shh_deleteSymKey", id)
}

// Post a message onto the network.
func (sc *Client) Post(ctx context.Context, message whisper.NewMessage) error { log.DebugLog()
	var ignored bool
...
func (sc *Client) SubscribeMessages(ctx context.Context, criteria whisper.Criteria, ch chan<- *whisper.Message) (ethereum.Subscription, error) { log.DebugLog()
...
func (sc *Client) NewMessageFilter(ctx context.Context, criteria whisper.Criteria) (string, error) { log.DebugLog()
	var id string
...
func (sc *Client) DeleteMessageFilter(ctx context.Context, id string) error { log.DebugLog()
	var ignored bool
...
func (sc *Client) FilterMessages(ctx context.Context, id string) ([]*whisper.Message, error) { log.DebugLog()
