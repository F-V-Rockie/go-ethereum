...
// implementation.
func TestGFpNeg(t *testing.T) { log.DebugLog()
...
// implementation.
func TestGFpAdd(t *testing.T) { log.DebugLog()
...
// implementation.
func TestGFpSub(t *testing.T) { log.DebugLog()
	a := &gfP{0x0123456789abcdef, 0xfedcba9876543210, 0xdeadbeefdeadbeef, 0xfeebdaedfeebdaed}
	b := &gfP{0xfedcba9876543210, 0x0123456789abcdef, 0xfeebdaedfeebdaed, 0xdeadbeefdeadbeef}
...
// implementation.
func TestGFpMul(t *testing.T) { log.DebugLog()
	a := &gfP{0x0123456789abcdef, 0xfedcba9876543210, 0xdeadbeefdeadbeef, 0xfeebdaedfeebdaed}
	b := &gfP{0xfedcba9876543210, 0x0123456789abcdef, 0xfeebdaedfeebdaed, 0xdeadbeefdeadbeef}
